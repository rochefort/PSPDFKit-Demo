...
(function() {
  $(window).load(function() {
    window.CaseStudies = new AWSlideshow("section.case-studies", {
      fadeElement: ".description"
    });
    return window.HeroTitles = new AWFadeCycle("section.hero .hero_container", 7500);
  });
